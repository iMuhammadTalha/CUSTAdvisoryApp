...
public class HeadAdvisorSEStudents extends AppCompatActivity {

    String urladdress=APIURL.BASE_URL+"headAdvisor_SEStudents.php";
    String[] regNo;
    String[] name;
    String[] phone;
    String[] cgpa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_head_advisor_sestudents);
        ...
        listView=(ListView)findViewById(R.id.SEStudentsList);

        StrictMode.setThreadPolicy((new StrictMode.ThreadPolicy.Builder().permitNetwork().build()));
        collectSEStudentsData();
        CustomSEStudentsListView customListView=new CustomSEStudentsListView(this, regNo, name, phone, cgpa, chr);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
                                     ...
                                     int position, long id)
            {
                ...
                {
                    Toast.makeText(HeadAdvisorSEStudents.this, "No result", Toast.LENGTH_SHORT).show();
                }else {
                    startActivity(i);
                }
            }
    ...
    private void collectSEStudentsData()
    {
//Connection
        try{
