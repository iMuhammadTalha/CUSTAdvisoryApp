...
public class HeadAdvisorAllAdvisors extends AppCompatActivity {

    String urladdress = APIURL.BASE_URL + "headAdvisor_AllAdvisors.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_head_advisor_all_advisors);
        ...
        listView = (ListView) findViewById(R.id.AllAdvisorsList);

        StrictMode.setThreadPolicy((new StrictMode.ThreadPolicy.Builder().permitNetwork().build()));
        collectAllAdvisorsData();
        CustomAllAdvisorListView customListView = new CustomAllAdvisorListView(this, AdvisorName, NoOfStudents, FirstStudent, LastStudent);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
                                     ...
                                     int position, long id)
            {
                ...
                {
                    Toast.makeText(HeadAdvisorAllAdvisors.this, "No result", Toast.LENGTH_SHORT).show();
                }else {
                    startActivity(i);
                }
            }
    ...
    private void collectAllAdvisorsData() {
//Connection
        try {
