...
public class CustomCSAdvisorListView extends ArrayAdapter<String> {
    ...
    public CustomCSAdvisorListView(Activity context,String[] AdvisorName,String[] NoOfStudents,String[] FirstStudent,String[] LastStudent) {
        super(context, R.layout.layoutcsadvisors,AdvisorName);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
        View r=convertView;
        CustomCSAdvisorListView.ViewHolder viewHolder=null;
        if(r==null){
            LayoutInflater layoutInflater=context.getLayoutInflater();
            r=layoutInflater.inflate(R.layout.layoutcsadvisors,null,true);
            viewHolder=new CustomCSAdvisorListView.ViewHolder(r);
            r.setTag(viewHolder);
        }
        else {
            viewHolder=(CustomCSAdvisorListView.ViewHolder)r.getTag();
