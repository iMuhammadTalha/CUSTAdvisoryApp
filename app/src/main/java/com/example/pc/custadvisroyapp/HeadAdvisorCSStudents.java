...
public class HeadAdvisorCSStudents extends AppCompatActivity {

    String urladdress=APIURL.BASE_URL+"headAdvisor_CSStudents.php";
    String[] regNo;
    String[] name;
    String[] phone;
    String[] cgpa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_head_advisor_csstudents);
        ...
        listView=(ListView)findViewById(R.id.CSStudentsList);

        StrictMode.setThreadPolicy((new StrictMode.ThreadPolicy.Builder().permitNetwork().build()));
        collectCSStudentsData();
        CustomCSStudentsListView customListView=new CustomCSStudentsListView(this, regNo, name, phone, cgpa, chr);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
                                     ...
                                     int position, long id)
            {
                ...
                {
                    Toast.makeText(HeadAdvisorCSStudents.this, "No result", Toast.LENGTH_SHORT).show();
                }else {
                    startActivity(i);
                }
            }
    ...
    private void collectCSStudentsData()
    {
//Connection
        try{
