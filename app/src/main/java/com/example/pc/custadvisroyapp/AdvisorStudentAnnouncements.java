...
public class AdvisorStudentAnnouncements extends AppCompatActivity {

    String urladdress=APIURL.BASE_URL+"advisor_StudentAnnouncement.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advisor_student_announcements);
