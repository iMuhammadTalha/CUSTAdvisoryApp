...
public class CustomSEAdvisorListView  extends ArrayAdapter<String> {
    ...
    public CustomSEAdvisorListView(Activity context,String[] AdvisorName,String[] NoOfStudents,String[] FirstStudent,String[] LastStudent) {
        super(context, R.layout.layoutseadvisors,AdvisorName);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
        View r=convertView;
        CustomSEAdvisorListView.ViewHolder viewHolder=null;
        if(r==null){
            LayoutInflater layoutInflater=context.getLayoutInflater();
            r=layoutInflater.inflate(R.layout.layoutseadvisors,null,true);
            viewHolder=new CustomSEAdvisorListView.ViewHolder(r);
            r.setTag(viewHolder);
        }
        else {
            viewHolder=(CustomSEAdvisorListView.ViewHolder)r.getTag();
