...
public class HeadAdvisorCSAdvisors extends AppCompatActivity {

    String urladdress = APIURL.BASE_URL + "headAdvisor_CSAdvisors.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_head_advisor_csadvisors);
        ...
        listView = (ListView) findViewById(R.id.CSAdvisorsList);

        StrictMode.setThreadPolicy((new StrictMode.ThreadPolicy.Builder().permitNetwork().build()));
        collectCSAdvisorsData();
        CustomCSAdvisorListView customListView = new CustomCSAdvisorListView(this, AdvisorName, NoOfStudents, FirstStudent, LastStudent);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
                                     ...
                                     int position, long id)
            {
                ...
                {
                    Toast.makeText(HeadAdvisorCSAdvisors.this, "No result", Toast.LENGTH_SHORT).show();
                }else {
                    startActivity(i);
                }
            }
    ...
    private void collectCSAdvisorsData() {
//Connection
        try {
